...
COUNTER=1
MAX_RETRY=15
ORGS="beneficiary agent government buyer"  #UPDATE REQUIRED
...
joinChannel() {
  ...
  joinChannelWithRetry 2 agent   #UPDATE REQUIRED
  joinChannelWithRetry 2 government   #UPDATE REQUIRED
  joinChannelWithRetry 2 buyer   #UPDATE REQUIRED
}
...
echo "Updating anchor peers for BENEFICIARY..."
updateAnchorPeers 0 'beneficiary'
echo "Updating anchor peers for AGENT..."
updateAnchorPeers 0 'agent'
echo "Updating anchor peers for GOVERNMENT..."
updateAnchorPeers 0 'government'
echo "Updating anchor peers for BUYER..."
updateAnchorPeers 0 'buyer'
